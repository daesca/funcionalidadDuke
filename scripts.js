...
function showElement(elementClicked){
    ...
    cantNegative = 32; //Cantidad de padding inicial
    var i = 0;
...
document.querySelector(".container-all-document").addEventListener("scroll", function(){ // or window.addEventListener("scroll"....
